...
바로 카드 문구부터 쓰지 말고 반드시 먼저 독자의 검색 의도와 궁금증을 분석한 뒤 8장 스토리를 설계하세요.
...
- 8장 전체의 역할과 흐름을 서로 겹치지 않게 설계합니다.

2단계 AI WRITER — 이탈 방지형 스토리 작성
- Planner 결과를 그대로 사용해 8장의 카드 문구를 작성합니다.
...
- 1~7장은 마지막 문장에 다음 장이 궁금해지는 짧고 자연스러운 연결 문장을 넣습니다.
...
- 8장까지 읽어야만 핵심 정리가 완성되는 점진적 구조를 만듭니다.
...
- 같은 내용을 반복하지 않습니다.
- 카드 1~7의 끝에는 다음 카드로 이어지는 자연스러운 전환을 포함합니다.
...
JSON만 출력하세요:
{
  "planner": {
    ...
    "story": ["1장 역할", "2장 역할", "3장 역할", "4장 역할", "5장 역할", "6장 역할", "7장 역할", "8장 역할"],
